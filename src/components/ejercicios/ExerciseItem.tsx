...
interface Props {
  ...
  onOptionsPress?: (ejercicio: Ejercicio) => void; // Evento para los 3 puntitos
  disableNavigation?: boolean; // Prop para deshabilitar la navegación
}
...
export default function ExerciseItem({
  ...
  return (
    ...
    >
      ...
      {/* RENDERIZADO CONDICIONAL: Solo mostramos los iconos si NO está deshabilitada la navegación */}
      {!disableNavigation && (
        <>
